    ...
    <div className="min-h-screen bg-[#f5f7fa] flex flex-col">
      ...
      <header className="bg-white border-b border-gray-200 px-8 py-5 sticky top-0 z-20">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-900">网络安全AI系统 v2.0</h1>
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-52 bg-white border-r border-gray-200 flex flex-col h-[calc(100vh-73px)] sticky top-[73px]">
          {/* Navigation Menu */}
